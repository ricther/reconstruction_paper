...
In order to solve this problem, we just need to measure the length of
every contour, and make sure that we only transform the shorter
contour to the longer one. Figure \ref{fig:the capping region problem} demonstrates that the length
check is very effective. As shown in fig. \ref{fig:the capping region
  problem}(b)-(c), the shrink was solved, and the correspondence is
almost correct, expect the section in red square. There is a gap like
a triangle in the red square, since there is no points as the
counterpart in the green contour for the red contour. So the points in
the red point corresponded to the nearest boundary points in the green
contour. We will solve this problem in the section\ref{medial axis}.
\begin{figure}[h]
\centering
\begin{subfigure}[b]{0.18\textwidth}
1)$
\begin{array}{l}
\includegraphics[width=\textwidth]{../picture/Degeneracy_original_20-1_21.png}
\end{array}$
\end{subfigure}
~~~~~~~~~~~~~~~
\begin{subfigure}[b]{0.18\textwidth}
$\begin{array}{l}
\includegraphics[width=\textwidth]{../picture/Degeneracy_correspondence_20-1_21.png}
\end{array}$
\end{subfigure}
~~~~~~~~~~~~~~~
\begin{subfigure}[b]{0.18\textwidth}
$\begin{array}{l}
\includegraphics[width=\textwidth]{../picture/Degeneracy_surface_20-1_21.png}
\end{array}$
\end{subfigure}
...
2)$
\begin{array}{l}
\includegraphics[width=\textwidth]{../picture/Degeneracy_original_20-2_21.png}
\end{array}$
\end{subfigure}
~~~~~~~~~~~~~~~
\begin{subfigure}[b]{0.18\textwidth}
$\begin{array}{l}
\includegraphics[width=\textwidth]{../picture/Degeneracy_correspondence_20-2_21.png}
\end{array}$
\end{subfigure}
~~~~~~~~~~~~~~~
\begin{subfigure}[b]{0.18\textwidth}
$\begin{array}{l}
\includegraphics[width=\textwidth]{../picture/Degeneracy_surface_20-2_21.png}
\end{array}$
\end{subfigure}
...
3)$
\begin{array}{l}
\includegraphics[width=\textwidth]{../picture/Degeneracy_original_20_21.png}
\end{array}$
\centerline{~~~~~~~~~(a)}
\end{subfigure}
~~~~~~~~~~~~~~~
\begin{subfigure}[b]{0.18\textwidth}
$\begin{array}{l}
\includegraphics[width=\textwidth]{../picture/Degeneracy_correspondence_20_21.png}
\end{array}$
\centerline{~~~~(b)}
\end{subfigure}
~~~~~~~~~~~~~~~
\begin{subfigure}[b]{0.18\textwidth}
$\begin{array}{l}
\includegraphics[width=\textwidth]{../picture/Degeneracy_surface_20_21.png}
\end{array}$
\centerline{~~~~(c)}
\end{subfigure}
\caption{The degeneracy of the capping region: There are two layers,
  the lower layer has two contours in red, the upper layer has one
  contour. 1) the lower contour is smaller
  one in the lower layer involved in the process. 2) the lower contour
  is  bigger one in  the lower layer involved in the process. 3) both
  contours in the lower layer involved in the process. (a) the original
  contours, the upper layer contains one contour in green, the lower
  contains one contour in red. (b) the correspondence based on the  IFFD. (c) the final surface 
}
...
\begin{subfigure}[b]{0.18\textwidth}
$\begin{array}{l}
\includegraphics[width=\textwidth]{../picture/Degeneracy_correspondence_length_20-1_21(1).png}
\end{array}$
\end{subfigure}
~~~~~~~~~~~~~~~
\begin{subfigure}[b]{0.18\textwidth}
$\begin{array}{l}
\includegraphics[width=\textwidth]{../picture/Degeneracy_surface_length_20-1_21.png}
\end{array}$
\end{subfigure}
...
\begin{subfigure}[b]{0.18\textwidth}
$\begin{array}{l}
\includegraphics[width=\textwidth]{../picture/Degeneracy_correspondence_length_20-2_21(1).png}
\end{array}$
\end{subfigure}
~~~~~~~~~~~~~~~
\begin{subfigure}[b]{0.18\textwidth}
$\begin{array}{l}
\includegraphics[width=\textwidth]{../picture/Degeneracy_surface_length_20-2_21.png}
\end{array}$
\end{subfigure}
...
\begin{subfigure}[b]{0.18\textwidth}
$\begin{array}{l}
\includegraphics[width=\textwidth]{../picture/Degeneracy_correspondence_length_20_21(1).png}
\end{array}$
\centerline{~~~~(b)}
\end{subfigure}
~~~~~~~~~~~~~~~
\begin{subfigure}[b]{0.18\textwidth}
$\begin{array}{l}
\includegraphics[width=\textwidth]{../picture/Degeneracy_surface_length_20_21.png}
\end{array}$
\centerline{~~~~(c)}
\end{subfigure}
...
\caption{the capping region problem: 1) both layer contain one
  contour, the process don't consider the length; 2) lower layer
  contains contain two contour in red, upper layer contains one
  contour in green. the process don't consider the length; 3) lower layer
  contains contain two contour in red, upper layer contains one
  contour in green. the process consider the length. (a)the original
  contours ;(b) the correspondence based on IFFD; (c) the final surface.
}
\label{fig:the capping region problem}
\end{figure}
...
upper layer  (fig.\ref{fig:synthetic data for branches}.2(b) red
...
fig.\ref{fig:synthetic data for branches}. 2(c),\ref{fig:synthetic data
  for branches}. 2(d).
...
We show some examples of running our algorithm in several
datasets. Reconstruction is used extensively in medical imaging. So
firstly, we provide the reconstruction from corss-section of human body.

Fig. shows the stanford bunny, which can demonstrate the ability of
our algorithm to cope with the branching problem,the ears are
classical branches.
